...
// има няколко варианта по които да процедураме, избрал съм тези които не са коментирани.
// отделно я бях решил по друг начин, без нуждата от прмиси и async await, но кода беше по нечетим
